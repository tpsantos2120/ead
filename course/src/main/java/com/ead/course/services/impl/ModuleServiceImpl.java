...
public class ModuleServiceImpl implements ModuleService {
    ...
    public void delete(ModuleModel moduleModel) {
        List<LessonModel> lessonModelList = lessonRepository.findAllLessonsByModuleId(moduleModel.getId());
    ...
    public Optional<ModuleModel> findModuleByCourse(UUID courseId, UUID moduleId) {
        return moduleRepository.findModuleByCourseId(courseId, moduleId);
    }

    @Override
    public Page<ModuleModel> findAll(SpecificationTemplate.ModuleSpec spec, Pageable pageable) {
