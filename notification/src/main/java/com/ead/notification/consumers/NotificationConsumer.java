...
public class NotificationConsumer {
    ...
    public void listen(@Payload NotificationCommandDto notificationCommandDto) {
        ...
        notificationModel.setCreatedDate(LocalDateTime.now(ZoneId.of("UTC")));
        notificationModel.setNotificationStatus(NotificationStatus.CREATED);
        NotificationModel savedNotification = notificationService.saveNotification(notificationModel);
    }
}
